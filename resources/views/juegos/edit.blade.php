            ...
            <form action="{{ route('juegos.update', $juego) }}" method="POST" novalidate>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nombre" id="nombre"
                        ...
                        value="{{ old('nombre', $juego->nombre) }}" placeholder="Introduce el nombre del juego">
                    @error('nombre')
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="min_jugadores" id="min_jugadores" min="1"
                        class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#f49d6e]"
                        value="{{ old('min_jugadores', $juego->min_jugadores) }}" placeholder="Ej: 2">
                    @error('min_jugadores')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="max_jugadores" id="max_jugadores" min="1"
                        class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#f49d6e]"
                        value="{{ old('max_jugadores', $juego->max_jugadores) }}" placeholder="Ej: 6">
                    @error('max_jugadores')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
